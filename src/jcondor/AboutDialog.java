...
// create about
      ...
      String k1="<h2> jCondor. A Condor status monitor</h2>";
      String k2="<b>Author: S.Chekanov (ANL/ASC. HEP division). 2010-2013</b><br>";
      String k3="<b>Version: 1.2</b><br>";
      String all=k1+k2+k3;
      epane.setText(all);
...
// create about
     ...
     try {
      ...
      public URL getHTMLUrl(String name) {
              URL url = null;
              try {
                      url = this.getClass().getResource("/jcondor/" + name);
              } catch (Exception e) {
              }
              return url;
      }
